...
<body>
            ...
            <li class="category_li first_li">
                ...
                <div class="Child_category_container">
                    <ul class="Child_category_ul">
                        ...
                        <li class="Child_category_li"><a href="product.php?categoryID=1" class="Child_category_a">安卓手機</a></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=2" class="Child_category_a">iPhone</a></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=3" class="Child_category_a">平板電腦</a></li>
                    </ul>
                    <ul class="Child_category_ul">
                        <li class="Child_category_li"><label class="Child_category_label">電腦/筆電</label></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=4" class="Child_category_a">筆記型電腦</a></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=5" class="Child_category_a">桌上型電腦</a></li>
                    </ul>
                    <ul class="Child_category_ul">
                        <li class="Child_category_li"><label class="Child_category_label">資訊週邊</label></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=6" class="Child_category_a">滑鼠</a></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=7" class="Child_category_a">鍵盤</a></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=8" class="Child_category_a">隨身碟</a></li>
                        <li class="Child_category_li"><a href="product.php?categoryID=9" class="Child_category_a">耳機</a></li>
                    </ul>
                </div>
            </li>
    ...
    <div class="product_container">
        <div class="prd_title" id="prd_title">
            <div class="prd_title_border">
                <ul>
                    <?php
                    // 輸出面包屑
                    echo '<li>';
                    echo '<i class="fa-solid fa-location-dot"></i>';
                    echo '\ <a href="../index.html" class="bread_crumbs">首頁</a> \ ';
            ...
            <div class="prd_title_box"><?php echo $categories[$categoryID]['name'] ?></div>
        </div>
        ...
        <?php
            ...
            // 輸出每個產品的資料
                while($row = $result->fetch_assoc()) {
                    echo ' 
                    <a href="product_detail.php?productid=' . $row["productID"] . '" class="product_a">
                        <img src="' . $row["productImg"] . '" alt="' . $row["productName"] . '" class="prdImg">
                        <p>
                            <span class="prdName">' . $row["productName"] . '</span>
                            <span class="prdPrice">$ <b>' . $row["productPrice"] . '</b></span>
                        </p>
                    </a>
                    ';
                }
            }else {
                echo '<p class="No_product">沒有找到符合的產品。</p>';
                echo '<script>
                        document.getElementById("prd_title").classList.add("x");
                    </script>';                  
            }
            $stmt->close();
        ?>
            ...
            <!-- <a href="" class="product_a">
                <img src="../image/10375826_01_002_R.webp" alt="" class="prdImg">
                <p>
                    <span class="prdName">立頓 茗閒情茶包<br> 3袋組★(活綠茶)</span>
                    <span class="prdPrice">$ <b>522</b></span>
                </p>
            </a> -->
